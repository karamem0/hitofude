...
describe('copyFile', () => {
  ...
  it('should copy the file when the parentId is provided', async () => {
    ...
    const params = {
      ...
      destinationFile: {
        id: '01BYE5RZ4FL7NVUU4UDVHIRG32OLTW4IKM',
        baseName: 'Annual Financial Report (DRAFT) 2',
        fullName: 'Annual Financial Report (DRAFT) 2.docx',
        extension: '.docx',
        mimeType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
        createdDate: new Date('2017-08-07T16:01:51Z'),
        updatedDate: new Date('2017-08-07T16:01:51Z'),
      ...
      name: 'Annual Financial Report (DRAFT) 2.docx'
    };
    const expected = {
      id: '01BYE5RZ4FL7NVUU4UDVHIRG32OLTW4IKM',
      baseName: 'Annual Financial Report (DRAFT) 2',
  ...
  it('should create a new folder when the parentId is provided', async () => {
    ...
    const params = {
      ...
      newFolder: {
        ...
        name: 'Demo Files',
        createdDate: new Date('2025-05-27T11:46:27Z'),
        updatedDate: new Date('2025-05-27T11:46:27Z'),
        root: false,
        webUrl: 'https://m365x214355-my.sharepoint.com/personal/meganb_m365x214355_onmicrosoft_com/Documents/Attachments/Demo%20Files',
        parentId: '01BYE5RZ6QN3ZWBTUFOFD3GSPGOHDJD36K',
        folders: [],
        files: []
      },
  ...
  it('should get the root folder', async () => {
    ...
    const params = {
      rootFolder: {
        ...
        updatedDate: new Date('2025-11-10T04:35:39Z'),
        root: true,
